...
(function() {
  ...
  LogNotifier = (function(superClass) {
    ...
    LogNotifier.prototype._onNotify = function() {
      var action, args, level, ref;
      action = arguments[0], args = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      level = (ref = action != null ? action.level : void 0) != null ? ref : 'info';
      return this.log(level, this._makeMessage.apply(this, [action].concat(slice.call(args))));
    };
