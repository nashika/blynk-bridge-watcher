...
(function() {
  var Base, EventEmitter, dot, merge,
  ...
  Base = (function(superClass) {
    ...
    function Base(parent, config, logger) {
      ...
      this._initializeChildrenCommon = bind(this._initializeChildrenCommon, this);
    ...
    Base.prototype._initializeChildren = function(config, key, ChildClass) {
      return this._initializeChildrenCommon(config, key, ChildClass, (function(_this) {
        return function(ChildClass, childConfig) {
          return new ChildClass(_this, childConfig);
        };
      })(this));
    };
    ...
    Base.prototype._initializeChildrenWithGenerator = function(config, key, ChildGenerator) {
      ...
      return this._initializeChildrenCommon(config, key, generator, (function(_this) {
        return function(generator, childConfig) {
          return generator.generate(_this, childConfig);
        };
      })(this));
    };

    Base.prototype._initializeChildrenCommon = function(config, key, generator, genFunc) {
      ...
      for (i = 0, len = childrenConfig.length; i < len; i++) {
        ...
        this[key][childConfig.name] = genFunc(generator, childConfig);
      }
