...
(function() {
  ...
  IfAction = (function(superClass) {
    ...
    function IfAction(parent, config, index) {
      this.run = bind(this.run, this);
      IfAction.__super__.constructor.call(this, parent, config, index);
      this._operator = this._checkConfig(config, 'operator', 'string');
      this._value = this._checkConfig(config, 'value', 'number');
      this._then = this._checkConfig(config, 'then', 'string');
      this._else = this._checkConfig(config, 'else', 'string');
    }
