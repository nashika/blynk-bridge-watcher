...
(function() {
  ...
  NotifyAction = (function(superClass) {
    ...
    function NotifyAction(parent, config) {
      this.run = bind(this.run, this);
      NotifyAction.__super__.constructor.call(this, parent, config);
    ...
    NotifyAction.prototype.run = function() {
      ...
      return (ref = bridge.parent.parent.notifiers[this._notifier]).emit.apply(ref, ['notify', this].concat(slice.call(args)));
    };
