...
(function() {
  ...
  Server = (function(superClass) {
    ...
    Server.prototype.notify = function() {
      var args, notifierName, options, ref;
      options = arguments[0], args = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      notifierName = options != null ? options.notifier : void 0;
      if (this._notifiers[notifierName]) {
        return (ref = this._notifiers[notifierName]).emit.apply(ref, ['notify', options].concat(slice.call(args)));
      }
    };
