...
Vue.component("if-action-node-content-component", require("./component/node-content/action/if-action-node-content-component.vue"));
Vue.component("log-action-node-content-component", require("./component/node-content/action/log-action-node-content-component.vue"));
Vue.component("notify-action-node-content-component", require("./component/node-content/action/notify-action-node-content-component.vue"));
Vue.component("read-action-node-content-component", require("./component/node-content/action/read-action-node-content-component.vue"));
Vue.component("write-action-node-content-component", require("./component/node-content/action/write-action-node-content-component.vue"));
